...
#SBATCH -J fmriprp2
# Outputs ----------------------------------
#SBATCH --mail-user=zachladwig@u.northwestern.edu
...
BIDS_DIR="/projects/b1081/member_directories/zladwig/neurohackademy/Nifti"
DERIVS_DIR="derivatives/preproc_fmriprep-20.2.0"
WORK_DIR="/projects/b1081/singularity_images/work_zl"
...
# clear contents of working directory - ZL don't do this for ME
# cd ${WORK_DIR} && rm -rf *